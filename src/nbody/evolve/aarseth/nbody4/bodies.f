...
*
      DO 10 I = 1,IBODY
          FIRR = 2.0*SQRT(F(1,I)**2 + F(2,I)**2 + F(3,I)**2)
    ...
    5     CONTINUE
     ...
     &                 (A(K),K=1,3), (XDOT(K,I),K=1,3), FIRR
    6     FORMAT (I6,I5,F7.3,F8.4,F7.1,F7.2,3X,3F7.2,3X,3F6.2,3X,F7.1)
   10 CONTINUE
*
...
*       Only print significant binaries.
   ...
   35     FORMAT ('   BINARY ',2I4,2F7.3,F7.1,1P3E9.1,0PF7.2,F8.3,I4,
     &                                                   1PE10.1,0PF7.2)
   40 CONTINUE
*
