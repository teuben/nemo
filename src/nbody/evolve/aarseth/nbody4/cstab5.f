...
*       Exit if more than one small distance ratio.
      IF (IR.GT.1) THEN
*         WRITE (5,2)  NSTEP1, I, (1.0/RINV(K),K=1,N-1)
...
*     RB = 0.04*RSUM
*     IF (1.0/RINV(1).GT.RB.OR.1.0/RINV(N-1).GT.RB) GO TO 40
*
...
*       Check hierarchical stability condition for bound close pair.
     ...
     &    RB0.GT.SEMI0.AND.RSUM.GT.5.0*RMAXC) THEN
          ITERM = -1
          WRITE (5,20)  ECC0, ECC1, SEMI, SEMI1, PMIN, PCRIT, SEMI2,
     &                  180.0*ALPHA/3.14
