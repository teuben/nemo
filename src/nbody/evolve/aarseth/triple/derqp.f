...
*       Combine vectorial components with relevant coefficients.
      ...
      C2 = C18 - C16 + C20 + A*R1
*
*       Form derivatives of the regularized Hamiltonian.
      DO 10 I = 1,4
          K = I + 4
   ...
   10 CONTINUE
*       End of standard formulation (1974 paper).
*
...
*     G2 = 1.0/U
      G2 = 1.0/SQRT(R1 + R2)
*
*       Form the explicit time derivative.
      TPR = TPR*G2
      IF (ITFAC.NE.0) THEN
          TFAC = TFAC*G2
          ITFAC = 0
      END IF
*
*       Include terms due to modified time transformation.
      GAMMA = G2*GAMMA
*     S6 = C19 + A*R2
      DO 20 I = 1,8
          QPR(I) = G2*QPR(I)
