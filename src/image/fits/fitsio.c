 ...
 * we used to use NEED_SWAP, now we use WORDS_BIGENDIAN (from $NEMOLIB)
 * instead, since it is generated by 'configure'
 */
...
/*
  ...
  It's done rather liberally, buyt reading it has real-valued, and converting
  back to an integer.
