...

real func_gauss3_hcn_10(real *x, real *p, int np)
{
...
void derv_gauss3_hcn_10(real *x, real *p, real *e, int np)
{
...
real func_gauss3_hcn(real *x, real *p, int np)
{
  ...
  if (debug_first) {
    dprintf(0,"gauss3_hcn: np=%d nc=%d\n",np,nc);
    dprintf(0,"gauss3_hcn: a,b5,c5,d: %g %g %g %g\n",p[0],p[1],p[2],p[3]);
    dprintf(0,"gauss3_hcn: dv=%g,%g,%g\n", dv1,dv2,dv3);
    dprintf(0,"gauss3_n2hp: av=%g,%g,%g\n",av1,av2,av3);
    debug_first = 0;
  }
