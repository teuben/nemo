...
def grid_density_gaussian_filter(x0, y0, x1, y1, w, h, x,y,r,rho):
    ...
    print "maskglob=",maskglob.size
    print "myix[maskglob]=",myix[maskglob].size
    print "myiy[maskglob]=",myiy[maskglob].size
...
def compute(file,out,component,times,xrange,sigma):
    ...
    while(uns.nextFrame("")):
        ...
        if ok:
            ...
            fig = plt.figure(figsize=(8,8),dpi=122)#figsize=(1024,1024))

            DPI = fig.get_dpi()
            print "DPI:", DPI
            DefaultSize = fig.get_size_inches()
            print "Default size in Inches", DefaultSize
            width  = DPI*DefaultSize[0]
            height = DPI*DefaultSize[1]
            ...
            sigma=(width/1024)*sigma_ori
            zd = grid_density_gaussian_filter(view_xmin, view_ymin, view_xmax, view_ymax, width,height, x, y, sigma,rho)
