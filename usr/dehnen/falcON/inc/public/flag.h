...
namespace nbdy {
  ...
  public:
    enum {
      ...
      AL_SINK       =  16                       // all children are sinks       
    };
    //--------------------------------------------------------------------------
    // data of class flag                                                       
    //--------------------------------------------------------------------------
  ...
  public:
    ...
    //--------------------------------------------------------------------------
    friend bool is_sink   (const flag*F) { return F->is_set(SINK); }
    friend bool al_sink   (const flag*F) { return F->is_set(AL_SINK); }
    ...
    friend bool is_sticky (const flag&F) { return F.is_set(STICKY); }
    //--------------------------------------------------------------------------
    friend bool is_sink   (const int&F) { return F & SINK; }
    friend bool al_sink   (const int&F) { return F & AL_SINK; }
