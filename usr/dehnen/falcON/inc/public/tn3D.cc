...
//                                                                             |
//-----------------------------------------------------------------------------+
#ifndef falcON_included_tn3D_cc
#define falcON_included_tn3D_cc
...
namespace nbdy {
  ...
  // implementing                                                             //
  //                                                                          //
  // nbdy::symt3D<K,S>::ass_out_prd();                                        //
  // nbdy::symt3D<K,S>::add_out_prd();                                        //
  // nbdy::symt3D<K,S>::sub_out_prd();                                        //
  //                                                                          //
  //////////////////////////////////////////////////////////////////////////////
...
namespace nbdy {
  ...
  // implementing                                                             //
  //                                                                          //
  // nbdy::symt3D<K,X>::ass_sym_prd();                                        //
  // nbdy::symt3D<K,X>::add_sym_prd();                                        //
  // nbdy::symt3D<K,X>::sub_sym_prd();                                        //
  //                                                                          //
  //////////////////////////////////////////////////////////////////////////////
...
namespace meta3D {
  ...
  tm<int K,int L, int M, int k1, int l1, int m1> struct syd_p {
    enum {
      ...
      L1 = l1+l1,
      M1 = m1+m1,
      P  = D<k1,l1,m1>::Z * TWO<K-L,K1-L1>::B *TWO<L-M,L1-M1>::B *TWO<M,M1>::B,
      I2 = TWO<L-L1,M-M1>::I
    };
  ...
  tm<int Q,int K,int L,int M> struct syd_as0 : public D<K/2,L/2,M/2>{
    ...
    sci I = TWO<L,M>::I;
    tX sv job(X*a)      { a[I] = (!(L&1 || M&1))?    Z : X(0) ; }
    tX sv job(X*a,cX&d) { a[I] = (!(L&1 || M&1))? d* Z : X(0) ; }
  };
  //----------------------------------------------------------------------------
  tm<int Q,int k,int l,int m> struct syd_ad0 : public D<k,l,m> {
    sci I = TWO<L,M>::I;
    tX sv job(X*a)      { a[I]+=    Z; }
    tX sv job(X*a,cX&d) { a[I]+= d* Z; }
  };
  //----------------------------------------------------------------------------
...
namespace nbdy {
  ...
  // implementing                                                             //
  //                                                                          //
  // nbdy::symt3D<K,X>::ass_del_prd();                                        //
  // nbdy::symt3D<K,X>::add_del_prd();                                        //
  // nbdy::symt3D<K,X>::sub_del_prd();                                        //
  //                                                                          //
  //////////////////////////////////////////////////////////////////////////////
...
namespace meta3D {
  ...
  struct inp_k : public inp_a<Kx,Ky,Kz> {                      // Kx,Ky,Kz      
    tX sX k(cX*b,cX*c) {
      return times<P>( inp_p<L1,M1,Ky,Kz>::p(b,c) +
  ...
  struct inp_k<L1,M1,Kx,Ky,Kx> : public inp_a<Kx,Ky,Kx> {      // Kz=Kx != Ky   
    tX sX k(cX*b,cX*c) {
      return times<P>( inp_p<L1,M1,Ky,Kx>::p(b,c) +
  ...
  //----------------------------------------------------------------------------
  tm<int L1,int M1,int Kx,int Ky>
  struct inp_k<L1,M1,Kx,Ky,Ky> : public inp_a<Kx,Ky,Ky> {      // Kz=Ky != Kx   
    tX sX k(cX*b,cX*c) {
      return times<P>( inp_p<L1,M1,Ky,Ky>::p(b,c) +
		       inp_p<L1,M1,Ky,Kx>::p(b,c) +
		       inp_p<L1,M1,Kx,Ky>::p(b,c) );
    }
  };
  ...
  struct inp_k<L1,M1,Kx,Kx,Kz> : public inp_a<Kx,Kx,Kz> {      // Ky=Kx != Kz   
    tX sX k(cX*b,cX*c) {
      return times<P>( inp_p<L1,M1,Kx,Kz>::p(b,c) +
		       inp_p<L1,M1,Kz,Kx>::p(b,c) +
		       inp_p<L1,M1,Kx,Kx>::p(b,c) );
    }
  };
  ...
  struct inp_k<L1,M1,Kx,Kx,Kx> : public inp_a<Kx,Kx,Kx> {      // Kx=Ky=Kz      
    tX sX k(cX*b,cX*c) {
      return times<P>( inp_p<L1,M1,Kx,Kx>::p(b,c) );
    }
  };
  //----------------------------------------------------------------------------
  //                                                                            
...
namespace nbdy {
  ...
  // implementing                                                             //
  //                                                                          //
  // nbdy::symt3D<K,X>::ass_inn_prd();                                        //
  // nbdy::symt3D<K,X>::add_inn_prd();                                        //
  // nbdy::symt3D<K,X>::sub_inn_prd();                                        //
  //                                                                          //
  //////////////////////////////////////////////////////////////////////////////
