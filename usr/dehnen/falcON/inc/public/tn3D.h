...
namespace nbdy {
  ...
  public:
    ...
    T&ass_out_prd   (symt3D<K-1,X> const&, tupel<3,X> const&);
    T&add_out_prd   (symt3D<K-1,X> const&, tupel<3,X> const&);
    T&sub_out_prd   (symt3D<K-1,X> const&, tupel<3,X> const&);
    T&ass_out_prd   (symt3D<K-1,X> const&, tupel<3,X> const&, X const&);
    T&add_out_prd   (symt3D<K-1,X> const&, tupel<3,X> const&, X const&);
    T&sub_out_prd   (symt3D<K-1,X> const&, tupel<3,X> const&, X const&);
    ...
    T&ass_sym_prd(symt3D<K-1,X> const&, tupel<3,X> const&);
    T&add_sym_prd(symt3D<K-1,X> const&, tupel<3,X> const&);
    T&sub_sym_prd(symt3D<K-1,X> const&, tupel<3,X> const&);
    T&ass_sym_prd(tupel<3,X> const&, symt3D<K-1,X> const&);
    T&add_sym_prd(tupel<3,X> const&, symt3D<K-1,X> const&);
    T&sub_sym_prd(tupel<3,X> const&, symt3D<K-1,X> const&);
    ...
    T&ass_sym_prd(symt3D<K-1,X> const&, tupel<3,X> const&, X const&);
    T&add_sym_prd(symt3D<K-1,X> const&, tupel<3,X> const&, X const&);
    T&sub_sym_prd(symt3D<K-1,X> const&, tupel<3,X> const&, X const&);
    T&ass_sym_prd(tupel<3,X> const&, symt3D<K-1,X> const&, X const&);
    T&add_sym_prd(tupel<3,X> const&, symt3D<K-1,X> const&, X const&);
    T&sub_sym_prd(tupel<3,X> const&, symt3D<K-1,X> const&, X const&);
    ...
    T&ass_del_prd(tupel<3,X> const&);
    T&ass_del_prd(tupel<3,X> const&, X const&);
    T&add_del_prd(tupel<3,X> const&);
    T&add_del_prd(tupel<3,X> const&, X const&);
    T&sub_del_prd(tupel<3,X> const&);
    T&sub_del_prd(tupel<3,X> const&, X const&);
    ...
    void ass_inn_prd(tupel<3,X>   const&, symt3D<K-1,X>&) const;
    template<int Q>
    void ass_inn_prd(symt3D<Q,X>  const&, symt3D<K-Q,X>&) const;
    void ass_inn_prd(symt3D<K-1,X>const&, tupel<3,X>   &) const;
    void ass_inn_prd(symt3D<K,X>  const&, X            &) const;

    void add_inn_prd(tupel<3,X>   const&, symt3D<K-1,X>&) const;
    template<int Q>
    void add_inn_prd(symt3D<Q,X>  const&, symt3D<K-Q,X>&) const;
    void add_inn_prd(symt3D<K-1,X>const&, tupel<3,X>   &) const;
    void add_inn_prd(symt3D<K,X>  const&, X            &) const;

    void sub_inn_prd(tupel<3,X>   const&, symt3D<K-1,X>&) const;
    template<int Q>
    void sub_inn_prd(symt3D<Q,X>  const&, symt3D<K-Q,X>&) const;
    void sub_inn_prd(symt3D<K-1,X>const&, tupel<3,X>   &) const;
    void sub_inn_prd(symt3D<K,X>  const&, X            &) const;
    X    ass_inn_prd(cT&p) const;
  };
  //////////////////////////////////////////////////////////////////////////////
  //                                                                          //
  // class nbdy::symt3D<2,X>                                                  //
  //                                                                          //
  //////////////////////////////////////////////////////////////////////////////
  ...
  public:
    ...
    T&ass_out_prd(tupel<3,X> const&);
    T&add_out_prd(tupel<3,X> const&);
    T&sub_out_prd(tupel<3,X> const&);
    T&ass_out_prd(tupel<3,X> const&, X const&);
    T&add_out_prd(tupel<3,X> const&, X const&);
    T&sub_out_prd(tupel<3,X> const&, X const&);
    // symmetric outer product                                                  
    // we =/+=/-= symmetric outer product of two vectors                        
    T&ass_sym_prd(tupel<3,X> const&, tupel<3,X> const&);
    T&add_sym_prd(tupel<3,X> const&, tupel<3,X> const&);
    T&sub_sym_prd(tupel<3,X> const&, tupel<3,X> const&);
    // we =/+=/-= s times the symmetric outer product of two vectors            
    T&ass_sym_prd(tupel<3,X> const&, tupel<3,X> const&, X const&);
    T&add_sym_prd(tupel<3,X> const&, tupel<3,X> const&, X const&);
    T&sub_sym_prd(tupel<3,X> const&, tupel<3,X> const&, X const&);
    // symmetric outer product of delta^(n)                                     
    T&ass_del_prd();
    T&ass_del_prd(X const&);
    T&add_del_prd();
    ...
    T&sub_del_prd(X const&);
    // complete inner product                                                   
    void ass_inn_prd(tupel<3,X>  const&, tupel<3,X>&) const;
    void ass_inn_prd(symt3D<2,X> const&, X         &) const;
    void add_inn_prd(tupel<3,X>  const&, tupel<3,X>&) const;
    void add_inn_prd(symt3D<2,X> const&, X         &) const;
    void sub_inn_prd(tupel<3,X>  const&, tupel<3,X>&) const;
  ...
  //////////////////////////////////////////////////////////////////////////////
  //                                                                          //
  // class nbdy::symt3D<1,X>                                                  //
  //                                                                          //
  // NOT to be used, use tupel<3,X> instead.                                  //
  //                                                                          //
  //////////////////////////////////////////////////////////////////////////////
...
#include <public/tn3D.cc>
////////////////////////////////////////////////////////////////////////////////
#endif	                                           // falcON_included_tn3D_h    
