...
\ifdebug
 \ifindex
  \documentstyle[nemo,twoside,makeidx,showidx,html,epsf]{report} % Debug;add [lablst]??
 \else
  \documentstyle[nemo,twoside,lablst,showlabels,html,epsf]{report} % Debug, no index
 \fi
\else
 \ifindex
  \documentstyle[nemo,twoside,makeidx,html,epsf]{report}           % Final w/index
 \else 
  \documentstyle[nemo,twoside,html,epsf]{report}                   % Final no index
 \fi
\fi
...
%               of course these chaps were all part of it, 
%		Josh write the initial version of chapter 6
% {J. E. Barnes} \\
...
\chapter                {Examples}
 \input examples.inc	
% The above input also includes: potential.inc
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
