...
Kang {\it et al. } compared the simulation results of a number
...
\section{Heitmann et all 2005}

Comparing cosmlogical N-body simulations. Codes:
...
also compared a few other datasets.
...
referred to as ``glass'' initial conditions. There can be obtained when
a Poisson sample in an expanding period box is evolved with the
