...
We will be using 25 Linux workstations, running Suse 10.1 (X86-64) with dual CPU 64bit 
Intel 3GHz processors. That's a total of 150 GHz !!

For those working on the Linux Lab machines, here is some essential 
information how to login and setup your account:

A common data directory {\tt /export/soft/gh06} is available on all 25
linux lab workstations. These machines are 
named {\tt c01tgh}, {\tt c02tgh} ... {\tt t24tgh} and the server
{\tt ctgh06}.   Each student has been assigned an account {\tt stud01}, 
{\tt stud02}, ... {\tt stud50}, the initial passwords are writting
on the white-board, but please change them.
{\it should we put all students in a unix group, with default group write
permission using umask 002??}

Printing should be done via the lj4050 in the lab. For those connecting their
...
\begin{verbatim}
    source /export/soft/gh06/manybody/manybody_start.csh
\end{verbatim}
or {\tt .bashrc} for bash users
\begin{verbatim}
    source /export/soft/gh06/manybody/manybody_start.sh
\end{verbatim}
...
The directory {\tt /export/soft/gh06} on the 25 Linux Lab machines
...
First an overview of the {\it manybody} hierarchy under {\tt /export/soft/gh06}:
