...
half the size. 
Hopefully we will be able to distill this on the reader too.
...
Also:
 ...
 - various collional codes compared: MC, nbody6, kira, grid codes etc.
...
{Initial conditions for the Pythagorean problem (left, but notice
